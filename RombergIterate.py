...
def rombergIterate(function, a, b, args=(), tol=1.48e-8, rtol=1.48e-8, show=False, divmax=10, vec_func=False):

    if isinf(a) or isinf(b):
        print('Romberg integration only available for finite limits.')
